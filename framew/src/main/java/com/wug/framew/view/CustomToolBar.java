...
import static com.wug.framew.factory.BaseFactoryKt.dp2px;
...
//            this.addMyView(this.mLeftText, Gravity.START);
    ...
    public CustomToolBar setLeftIcon(Drawable drawable) {
        ...
        if (this.mLeftIcon == null) {
            ...
            //保持点击区域
            int padding = (int) this.getContext().getResources().getDimension(R.dimen.common_margin);
...
//            this.addMyView(this.mCenterTitle, Gravity.CENTER);
    ...
    public void setMySettingText(CharSequence text) {
        ...
        mSettingText.setTextColor(getResources().getColor(R.color.colorPrimary));
